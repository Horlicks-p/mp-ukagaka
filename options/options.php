...
<div class="wrap mp-ukagaka-wrap mpu-frieren-admin">
    ...
    <div class="mp-ukagaka-main-layout">
        ...
        <!-- タブナビ（grid row 1, col 1） -->
        <div class="mp-ukagaka-tabs">
            <a class="<?php echo $cur_page == 0 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=0')); ?>"><?php _e('⚙️ 通用設定', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 5 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=5')); ?>"><?php _e('🧠 AI 設定', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 6 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=6')); ?>"><?php _e('🤖 LLM 設定', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 7 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=7')); ?>"><?php _e('📓 日記設定', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 4 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=4')); ?>"><?php _e('💬 會話', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 1 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=1')); ?>"><?php _e('👻 偽春菜們', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 2 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=2')); ?>"><?php _e('✨ 創建新偽春菜', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 3 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=3')); ?>"><?php _e('🔌 擴展', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 9 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=9')); ?>"><?php _e('🛡️ Bot 防護', 'mp-ukagaka'); ?></a>
            <a class="<?php echo $cur_page == 8 ? 'active' : ''; ?>" href="<?php echo esc_url(admin_url('options-general.php?page=' . $base_name . '&cur_page=8')); ?>"><?php _e('📊 統計', 'mp-ukagaka'); ?></a>
        </div>

        <!-- コンテンツ（grid row 2, col 1） -->
