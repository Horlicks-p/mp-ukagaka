...
<div id="mp_ukagaka">
    <div id="ukagaka_shell">
        ...
        // 替換 $msglist_json 的生成方式以確保安全，使用 JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_QUOT|JSON_HEX_AMP
        $msglist_json = htmlspecialchars(
            wp_json_encode(
                $msglist,
        ...
        // 取得預設顯示訊息
        $initial_msg = $msglist["msg"][0] ?? "";
        $initial_auto_msg = $msglist["auto_msg"] ?? "";
    ...
    <div id="ukagaka_shell">
        <div id="ukagaka">
            <div id="ukagaka_msgbox">
                <div class="ukagaka-msgbox-top"></div>
                <div id="ukagaka_msg">' .
            mpu_html_decode($initial_msg . $initial_auto_msg) .
            '</div>
                <div id="ukagaka_msgnum" style="display:none;">0</div>
