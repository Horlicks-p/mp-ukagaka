...
- 已遷移 `js/ukagaka-anime.js` 的 5 條 production-visible error/warn，以及 `ghost/Frieren/frieren.js` 裝飾配置載入流程的 4 條 production-visible error/warn；輸出時機維持不變，direct `console.warn` 仍使用 always-output 路徑。
