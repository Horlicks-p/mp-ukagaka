...
function mpu_load_modules()
{
    ...
    $core_modules = [
        ...
        'core/class-mpu-observation-buffer.php', // Session-scoped volatile visitor activity buffer
        'core/class-mpu-log-i18n-builder.php', // Front-end console log i18n payload builder
        ...
        'llm/class-mpu-chat-lock.php', // Chat lifecycle lock（並行 LLM request 防護）
		...
		'llm/class-mpu-stream-output-parser.php', // SSE 輸出狀態機（emotion event / think block，§13.3）.
